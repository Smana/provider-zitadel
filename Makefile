...
PROJECT_REPO ?= github.com/Smana/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/zitadel/terraform-provider-zitadel.git
export TERRAFORM_PROVIDER_VERSION ?= 2.0.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-zitadel
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/zitadel/${TERRAFORM_PROVIDER_DOWNLOAD_NAME}/releases/download/${TERRAFORM_PROVIDER_VERSION}
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-zitadel_v2.0.1
