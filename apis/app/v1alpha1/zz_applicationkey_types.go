...
type ApplicationKeyInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/Smana/provider-zitadel/apis/app/v1alpha1.ApplicationApi
	AppID *string `json:"appId,omitempty" tf:"app_id,omitempty"`

	// Reference to a ApplicationApi in app to populate appId.
	// +kubebuilder:validation:Optional
	AppIDRef *v1.Reference `json:"appIdRef,omitempty" tf:"-"`

	// Selector for a ApplicationApi in app to populate appId.
	// +kubebuilder:validation:Optional
	...
	// ID of the project
	// +crossplane:generate:reference:type=github.com/Smana/provider-zitadel/apis/project/v1alpha1.Project
