...
type OrgIdpGithubEsInitParameters struct {
...
type OrgIdpGithubEsObservation struct {
...
type OrgIdpGithubEsParameters struct {
...
// OrgIdpGithubEsSpec defines the desired state of OrgIdpGithubEs
type OrgIdpGithubEsSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrgIdpGithubEsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrgIdpGithubEsInitParameters `json:"initProvider,omitempty"`
}

// OrgIdpGithubEsStatus defines the observed state of OrgIdpGithubEs.
type OrgIdpGithubEsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrgIdpGithubEsObservation `json:"atProvider,omitempty"`
}
...
// OrgIdpGithubEs is the Schema for the OrgIdpGithubEss API. Resource representing a GitHub Enterprise IdP on the organization.
...
type OrgIdpGithubEs struct {
	...
	Spec   OrgIdpGithubEsSpec   `json:"spec"`
	Status OrgIdpGithubEsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrgIdpGithubEsList contains a list of OrgIdpGithubEss
type OrgIdpGithubEsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrgIdpGithubEs `json:"items"`
}

// Repository type metadata.
var (
	OrgIdpGithubEs_Kind             = "OrgIdpGithubEs"
	OrgIdpGithubEs_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgIdpGithubEs_Kind}.String()
	OrgIdpGithubEs_KindAPIVersion   = OrgIdpGithubEs_Kind + "." + CRDGroupVersion.String()
	OrgIdpGithubEs_GroupVersionKind = CRDGroupVersion.WithKind(OrgIdpGithubEs_Kind)
)

func init() {
	SchemeBuilder.Register(&OrgIdpGithubEs{}, &OrgIdpGithubEsList{})
}
