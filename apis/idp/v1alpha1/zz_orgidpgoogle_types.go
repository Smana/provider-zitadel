...
type OrgIdpGoogleInitParameters struct {
...
type OrgIdpGoogleObservation struct {
...
type OrgIdpGoogleParameters struct {
...
// OrgIdpGoogleSpec defines the desired state of OrgIdpGoogle
type OrgIdpGoogleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrgIdpGoogleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrgIdpGoogleInitParameters `json:"initProvider,omitempty"`
}

// OrgIdpGoogleStatus defines the observed state of OrgIdpGoogle.
type OrgIdpGoogleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrgIdpGoogleObservation `json:"atProvider,omitempty"`
}
...
// OrgIdpGoogle is the Schema for the OrgIdpGoogles API. Resource representing a Google IdP on the organization.
...
type OrgIdpGoogle struct {
	...
	Spec   OrgIdpGoogleSpec   `json:"spec"`
	Status OrgIdpGoogleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrgIdpGoogleList contains a list of OrgIdpGoogles
type OrgIdpGoogleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrgIdpGoogle `json:"items"`
}

// Repository type metadata.
var (
	OrgIdpGoogle_Kind             = "OrgIdpGoogle"
	OrgIdpGoogle_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgIdpGoogle_Kind}.String()
	OrgIdpGoogle_KindAPIVersion   = OrgIdpGoogle_Kind + "." + CRDGroupVersion.String()
	OrgIdpGoogle_GroupVersionKind = CRDGroupVersion.WithKind(OrgIdpGoogle_Kind)
)

func init() {
	SchemeBuilder.Register(&OrgIdpGoogle{}, &OrgIdpGoogleList{})
}
