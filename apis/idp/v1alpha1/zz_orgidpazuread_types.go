...
type OrgIdpAzureAdInitParameters struct {
...
type OrgIdpAzureAdObservation struct {
...
type OrgIdpAzureAdParameters struct {
...
// OrgIdpAzureAdSpec defines the desired state of OrgIdpAzureAd
type OrgIdpAzureAdSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrgIdpAzureAdParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrgIdpAzureAdInitParameters `json:"initProvider,omitempty"`
}

// OrgIdpAzureAdStatus defines the observed state of OrgIdpAzureAd.
type OrgIdpAzureAdStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrgIdpAzureAdObservation `json:"atProvider,omitempty"`
}
...
// OrgIdpAzureAd is the Schema for the OrgIdpAzureAds API. Resource representing an Azure AD IdP on the organization.
...
type OrgIdpAzureAd struct {
	...
	Spec   OrgIdpAzureAdSpec   `json:"spec"`
	Status OrgIdpAzureAdStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrgIdpAzureAdList contains a list of OrgIdpAzureAds
type OrgIdpAzureAdList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrgIdpAzureAd `json:"items"`
}

// Repository type metadata.
var (
	OrgIdpAzureAd_Kind             = "OrgIdpAzureAd"
	OrgIdpAzureAd_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgIdpAzureAd_Kind}.String()
	OrgIdpAzureAd_KindAPIVersion   = OrgIdpAzureAd_Kind + "." + CRDGroupVersion.String()
	OrgIdpAzureAd_GroupVersionKind = CRDGroupVersion.WithKind(OrgIdpAzureAd_Kind)
)

func init() {
	SchemeBuilder.Register(&OrgIdpAzureAd{}, &OrgIdpAzureAdList{})
}
