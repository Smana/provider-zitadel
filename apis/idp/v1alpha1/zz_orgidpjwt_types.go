...
type OrgIdpJwtInitParameters struct {
...
type OrgIdpJwtObservation struct {
...
// OrgIdpJwtSpec defines the desired state of OrgIdpJwt
type OrgIdpJwtSpec struct {
	...
	// autoscaler.
	InitProvider OrgIdpJwtInitParameters `json:"initProvider,omitempty"`
}

// OrgIdpJwtStatus defines the observed state of OrgIdpJwt.
...
// OrgIdpJwt is the Schema for the OrgIdpJwts API. Resource representing a generic JWT IdP of the organization.
...
// OrgIdpJwtList contains a list of OrgIdpJwts
...
var (
	OrgIdpJwt_Kind             = "OrgIdpJwt"
	OrgIdpJwt_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgIdpJwt_Kind}.String()
	OrgIdpJwt_KindAPIVersion   = OrgIdpJwt_Kind + "." + CRDGroupVersion.String()
	OrgIdpJwt_GroupVersionKind = CRDGroupVersion.WithKind(OrgIdpJwt_Kind)
)
