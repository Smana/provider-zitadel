...
type OrgIdpOauthInitParameters struct {
...
type OrgIdpOauthObservation struct {
...
// OrgIdpOauthSpec defines the desired state of OrgIdpOauth
type OrgIdpOauthSpec struct {
	...
	// autoscaler.
	InitProvider OrgIdpOauthInitParameters `json:"initProvider,omitempty"`
}

// OrgIdpOauthStatus defines the observed state of OrgIdpOauth.
...
// OrgIdpOauth is the Schema for the OrgIdpOauths API. Resource representing a generic OAuth2 IDP on the organization.
...
// OrgIdpOauthList contains a list of OrgIdpOauths
...
var (
	OrgIdpOauth_Kind             = "OrgIdpOauth"
	OrgIdpOauth_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgIdpOauth_Kind}.String()
	OrgIdpOauth_KindAPIVersion   = OrgIdpOauth_Kind + "." + CRDGroupVersion.String()
	OrgIdpOauth_GroupVersionKind = CRDGroupVersion.WithKind(OrgIdpOauth_Kind)
)
