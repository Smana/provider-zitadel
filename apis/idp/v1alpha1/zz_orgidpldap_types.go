...
type OrgIdpLdapInitParameters struct {
...
type OrgIdpLdapObservation struct {
...
// OrgIdpLdapSpec defines the desired state of OrgIdpLdap
type OrgIdpLdapSpec struct {
	...
	// autoscaler.
	InitProvider OrgIdpLdapInitParameters `json:"initProvider,omitempty"`
}

// OrgIdpLdapStatus defines the observed state of OrgIdpLdap.
...
// OrgIdpLdap is the Schema for the OrgIdpLdaps API. Resource representing an LDAP IdP on the organization.
...
// OrgIdpLdapList contains a list of OrgIdpLdaps
...
var (
	OrgIdpLdap_Kind             = "OrgIdpLdap"
	OrgIdpLdap_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgIdpLdap_Kind}.String()
	OrgIdpLdap_KindAPIVersion   = OrgIdpLdap_Kind + "." + CRDGroupVersion.String()
	OrgIdpLdap_GroupVersionKind = CRDGroupVersion.WithKind(OrgIdpLdap_Kind)
)
