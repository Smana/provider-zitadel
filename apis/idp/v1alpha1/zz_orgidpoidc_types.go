...
type OrgIdpOidcInitParameters struct {
...
type OrgIdpOidcObservation struct {
...
// OrgIdpOidcSpec defines the desired state of OrgIdpOidc
type OrgIdpOidcSpec struct {
	...
	// autoscaler.
	InitProvider OrgIdpOidcInitParameters `json:"initProvider,omitempty"`
}

// OrgIdpOidcStatus defines the observed state of OrgIdpOidc.
...
// OrgIdpOidc is the Schema for the OrgIdpOidcs API. Resource representing a generic OIDC IdP on the organization.
...
// OrgIdpOidcList contains a list of OrgIdpOidcs
...
var (
	OrgIdpOidc_Kind             = "OrgIdpOidc"
	OrgIdpOidc_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgIdpOidc_Kind}.String()
	OrgIdpOidc_KindAPIVersion   = OrgIdpOidc_Kind + "." + CRDGroupVersion.String()
	OrgIdpOidc_GroupVersionKind = CRDGroupVersion.WithKind(OrgIdpOidc_Kind)
)
